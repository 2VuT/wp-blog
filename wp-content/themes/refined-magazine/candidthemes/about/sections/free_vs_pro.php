...
<table class="table">
    <thead>
        <tr>
            <th class="db-bk-color-one"><?php esc_html_e('Theme Features', 'refined-magazine'); ?></th>
            <th class="db-bk-color-two"><?php esc_html_e('Refined Magazine Free', 'refined-magazine'); ?></th>
            <th class="db-bk-color-two"><?php esc_html_e('Refined Magazine Premium', 'refined-magazine'); ?></th>
        </tr>
    </thead>
     <tbody>
...
<div class="button-wrapper">
	<a href="https://www.candidthemes.com/themes/refined-magazine-pro/" class="btn" target="_blank"><?php esc_html_e('Buy Now','refined-magazine'); ?></a>
</div>
</div><!-- .wpopsection -->
<?php
