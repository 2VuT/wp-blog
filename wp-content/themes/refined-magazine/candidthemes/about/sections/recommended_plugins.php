<?php
					...
					<div class="recom-plugin-wrap">
						<div class="plugin-img-wrap">
							...
							<div class="version-author-info">
								<span class="version"><?php echo esc_html__('Version ', 'refined-magazine') . esc_html($plugin['version']); ?></span>
						...
						<div class="plugin-title-install clearfix">
							...
							<span class="plugin-action-btn plugin-btn-wrapper plugin-card-<?php echo esc_attr($plugin['slug']); ?>">
								<a class="<?php echo esc_attr($btn_class); ?>" data-host-type="<?php echo esc_attr($plugin['host_type']); ?>" data-file="<?php echo esc_attr($plugin['filename']); ?>" data-class="<?php echo esc_attr($plugin['class']); ?>" data-slug="<?php echo esc_attr($plugin['slug']); ?>" href="<?php echo esc_attr($p_link); ?>"><?php echo esc_html($label); ?></a>
							</span>
						</div>
					</div>
				<?php
	...
	if( !empty($this->free_plugins) ) {
		...
		foreach($this->free_plugins as $plugin) {
			...
			$p_status = $this->get_plugin_active($plugin);
			$btn_url = $this->generate_plugin_url($p_status, $plugin);
			...
			?>
				<div class="recom-plugin-wrap">
					<div class="plugin-img-wrap">
						<img src="<?php echo esc_url($icon_url); ?>" />
						<div class="version-author-info">
							<span class="version"><?php echo esc_html__('Version ', 'refined-magazine') . esc_html($info->version); ?></span>
							<span class="seperator">|</span>
